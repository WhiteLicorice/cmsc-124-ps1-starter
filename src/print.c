/*
 * print.c -- canonical printed forms. Given to you, complete.
 *
 * The grading corpus compares stdout byte for byte, so every value has exactly
 * one spelling and it lives here. Nothing in this file is yours to change.
 */
